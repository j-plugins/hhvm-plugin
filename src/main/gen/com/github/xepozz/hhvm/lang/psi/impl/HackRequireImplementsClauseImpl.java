...
public class HackRequireImplementsClauseImpl extends ASTWrapperPsiElement implements HackRequireImplementsClause {

  public HackRequireImplementsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitRequireImplementsClause(this);
  }
