...
public class HackArgumentsImpl extends ASTWrapperPsiElement implements HackArguments {

  public HackArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HackArgument> getArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackArgument.class);
  }
