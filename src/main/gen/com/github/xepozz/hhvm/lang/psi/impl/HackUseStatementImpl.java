...
public class HackUseStatementImpl extends HackStatementImpl implements HackUseStatement {
  ...
  public HackUseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HackUseClause> getUseClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackUseClause.class);
  }

  @Override
  @Nullable
  public HackUseType getUseType() {
    return findChildByClass(HackUseType.class);
  }
