...
public class HackTypeParametersImpl extends ASTWrapperPsiElement implements HackTypeParameters {

  public HackTypeParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HackTypeParameter> getTypeParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackTypeParameter.class);
  }
