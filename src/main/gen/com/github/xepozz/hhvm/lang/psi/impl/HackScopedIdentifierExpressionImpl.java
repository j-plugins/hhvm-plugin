...
public class HackScopedIdentifierExpressionImpl extends HackExpressionImpl implements HackScopedIdentifierExpression {

  public HackScopedIdentifierExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitScopedIdentifierExpression(this);
  }
