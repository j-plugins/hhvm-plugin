...
public class HackVariadicModifierImpl extends ASTWrapperPsiElement implements HackVariadicModifier {

  public HackVariadicModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitVariadicModifier(this);
  }
