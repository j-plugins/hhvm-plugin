...
public class HackTryStatementImpl extends HackStatementImpl implements HackTryStatement {
  ...
  public HackTryStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HackCatchClause> getCatchClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackCatchClause.class);
  }
  ...
  @Override
  @Nullable
  public HackFinallyClause getFinallyClause() {
    return findChildByClass(HackFinallyClause.class);
  }
