...
public class HackParameterImpl extends ASTWrapperPsiElement implements HackParameter {

  public HackParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public HackInoutModifier getInoutModifier() {
    return findChildByClass(HackInoutModifier.class);
  }
  ...
  @Override
  @Nullable
  public HackVariadicModifier getVariadicModifier() {
    return findChildByClass(HackVariadicModifier.class);
  }

  @Override
  @Nullable
  public HackVisibilityModifier getVisibilityModifier() {
    return findChildByClass(HackVisibilityModifier.class);
  }
