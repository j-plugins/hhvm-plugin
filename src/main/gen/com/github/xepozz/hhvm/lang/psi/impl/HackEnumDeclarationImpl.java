...
public class HackEnumDeclarationImpl extends ASTWrapperPsiElement implements HackEnumDeclaration {

  public HackEnumDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HackEnumerator> getEnumeratorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackEnumerator.class);
  }
