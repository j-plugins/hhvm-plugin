...
public class HackTraitSelectClauseImpl extends ASTWrapperPsiElement implements HackTraitSelectClause {

  public HackTraitSelectClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitTraitSelectClause(this);
  }
