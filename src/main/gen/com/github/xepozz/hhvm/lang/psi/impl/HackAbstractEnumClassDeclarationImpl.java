...
public class HackAbstractEnumClassDeclarationImpl extends ASTWrapperPsiElement implements HackAbstractEnumClassDeclaration {

  public HackAbstractEnumClassDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitAbstractEnumClassDeclaration(this);
  }
  ...
  @Override
  @NotNull
  public List<HackTypedEnumerator> getTypedEnumeratorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackTypedEnumerator.class);
  }
