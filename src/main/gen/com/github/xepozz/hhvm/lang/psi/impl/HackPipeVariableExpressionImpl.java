...
public class HackPipeVariableExpressionImpl extends HackExpressionImpl implements HackPipeVariableExpression {

  public HackPipeVariableExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitPipeVariableExpression(this);
  }
