...
public class HackInterfaceDeclarationImpl extends ASTWrapperPsiElement implements HackInterfaceDeclaration {

  public HackInterfaceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
