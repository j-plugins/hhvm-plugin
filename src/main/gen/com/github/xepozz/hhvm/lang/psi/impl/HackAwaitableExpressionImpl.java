...
public class HackAwaitableExpressionImpl extends HackExpressionImpl implements HackAwaitableExpression {

  public HackAwaitableExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitAwaitableExpression(this);
  }
