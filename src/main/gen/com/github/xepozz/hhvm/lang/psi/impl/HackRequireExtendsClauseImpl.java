...
public class HackRequireExtendsClauseImpl extends ASTWrapperPsiElement implements HackRequireExtendsClause {

  public HackRequireExtendsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitRequireExtendsClause(this);
  }
