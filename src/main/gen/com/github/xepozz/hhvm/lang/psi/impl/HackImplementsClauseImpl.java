...
public class HackImplementsClauseImpl extends ASTWrapperPsiElement implements HackImplementsClause {

  public HackImplementsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
