...
public class HackExpressionCallExpressionImpl extends HackExpressionImpl implements HackExpressionCallExpression {

  public HackExpressionCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitExpressionCallExpression(this);
  }
  ...
  @Override
  @NotNull
  public HackArguments getArguments() {
    return findNotNullChildByClass(HackArguments.class);
  }
