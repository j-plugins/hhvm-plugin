...
public class HackConcurrentStatementImpl extends HackStatementImpl implements HackConcurrentStatement {

  public HackConcurrentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
