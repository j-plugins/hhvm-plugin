...
public class HackYieldExpressionImpl extends HackExpressionImpl implements HackYieldExpression {
  ...
  public HackYieldExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public HackElementInitializer getElementInitializer() {
    return findChildByClass(HackElementInitializer.class);
  }
