...
public class HackAttributeModifierImpl extends ASTWrapperPsiElement implements HackAttributeModifier {

  public HackAttributeModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
