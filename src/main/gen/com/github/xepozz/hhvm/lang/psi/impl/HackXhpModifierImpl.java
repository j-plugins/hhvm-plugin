...
public class HackXhpModifierImpl extends ASTWrapperPsiElement implements HackXhpModifier {

  public HackXhpModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitXhpModifier(this);
  }
