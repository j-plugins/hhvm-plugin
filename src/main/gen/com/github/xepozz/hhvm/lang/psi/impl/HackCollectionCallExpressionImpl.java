...
public class HackCollectionCallExpressionImpl extends HackExpressionImpl implements HackCollectionCallExpression {

  public HackCollectionCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitCollectionCallExpression(this);
  }
