...
public class HackPrefixUnaryExpressionImpl extends HackExpressionImpl implements HackPrefixUnaryExpression {

  public HackPrefixUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
