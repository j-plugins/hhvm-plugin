...
public class HackPropertyDeclaratorImpl extends ASTWrapperPsiElement implements HackPropertyDeclarator {

  public HackPropertyDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitPropertyDeclarator(this);
  }
