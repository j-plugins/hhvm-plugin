...
public class HackSubscriptExpressionImpl extends HackExpressionImpl implements HackSubscriptExpression {

  public HackSubscriptExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
