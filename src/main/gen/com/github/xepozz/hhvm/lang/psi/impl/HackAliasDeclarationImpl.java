...
public class HackAliasDeclarationImpl extends ASTWrapperPsiElement implements HackAliasDeclaration {

  public HackAliasDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
