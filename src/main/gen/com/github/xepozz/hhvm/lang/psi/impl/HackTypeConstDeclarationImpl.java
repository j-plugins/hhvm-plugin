...
public class HackTypeConstDeclarationImpl extends ASTWrapperPsiElement implements HackTypeConstDeclaration {

  public HackTypeConstDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitTypeConstDeclaration(this);
  }
