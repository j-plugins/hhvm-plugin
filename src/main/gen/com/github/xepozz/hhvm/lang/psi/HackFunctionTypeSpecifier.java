...
public interface HackFunctionTypeSpecifier extends PsiElement {
  ...
  @NotNull
  List<HackInoutModifier> getInoutModifierList();
  ...
  @NotNull
  List<HackVariadicModifier> getVariadicModifierList();
