...
public class HackAwaitModifierImpl extends ASTWrapperPsiElement implements HackAwaitModifier {

  public HackAwaitModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitAwaitModifier(this);
  }
