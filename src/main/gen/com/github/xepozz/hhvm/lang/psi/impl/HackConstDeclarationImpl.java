...
public class HackConstDeclarationImpl extends ASTWrapperPsiElement implements HackConstDeclaration {

  public HackConstDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<HackConstDeclarator> getConstDeclaratorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HackConstDeclarator.class);
  }
