...
public class HackScopeIdentifierExpressionImpl extends HackExpressionImpl implements HackScopeIdentifierExpression {

  public HackScopeIdentifierExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitScopeIdentifierExpression(this);
  }
