...
public class HackWhereConstraintImpl extends ASTWrapperPsiElement implements HackWhereConstraint {

  public HackWhereConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitWhereConstraint(this);
  }
