...
public class HackAbstractModifierImpl extends ASTWrapperPsiElement implements HackAbstractModifier {

  public HackAbstractModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
