...
public class HackQualifiedIdentifierExpressionImpl extends HackExpressionImpl implements HackQualifiedIdentifierExpression {

  public HackQualifiedIdentifierExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitQualifiedIdentifierExpression(this);
  }
