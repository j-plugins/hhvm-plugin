...
public class HackXhpSpreadExpressionImpl extends HackExpressionImpl implements HackXhpSpreadExpression {

  public HackXhpSpreadExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitXhpSpreadExpression(this);
  }
