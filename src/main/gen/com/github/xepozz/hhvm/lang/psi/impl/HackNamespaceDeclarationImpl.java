...
public class HackNamespaceDeclarationImpl extends ASTWrapperPsiElement implements HackNamespaceDeclaration {

  public HackNamespaceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
