...
public class HackXhpStringImpl extends ASTWrapperPsiElement implements HackXhpString {

  public HackXhpStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitXhpString(this);
  }
