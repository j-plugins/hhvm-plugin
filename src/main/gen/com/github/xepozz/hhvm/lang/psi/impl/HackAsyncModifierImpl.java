...
public class HackAsyncModifierImpl extends ASTWrapperPsiElement implements HackAsyncModifier {

  public HackAsyncModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitAsyncModifier(this);
  }
