...
public class HackSelectionExpressionImpl extends HackExpressionImpl implements HackSelectionExpression {

  public HackSelectionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
