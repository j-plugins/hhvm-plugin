...
public class HackPostfixUnaryExpressionImpl extends HackExpressionImpl implements HackPostfixUnaryExpression {

  public HackPostfixUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
