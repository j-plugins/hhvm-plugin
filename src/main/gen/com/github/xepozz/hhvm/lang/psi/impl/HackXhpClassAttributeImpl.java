...
public class HackXhpClassAttributeImpl extends ASTWrapperPsiElement implements HackXhpClassAttribute {

  public HackXhpClassAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitXhpClassAttribute(this);
  }
  ...
  @Override
  @Nullable
  public HackXhpEnumType getXhpEnumType() {
    return findChildByClass(HackXhpEnumType.class);
  }
