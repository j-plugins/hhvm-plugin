...
public class HackTypedEnumeratorImpl extends ASTWrapperPsiElement implements HackTypedEnumerator {

  public HackTypedEnumeratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitTypedEnumerator(this);
  }
  ...
  @Override
  @NotNull
  public HackEnumerator getEnumerator() {
    return findNotNullChildByClass(HackEnumerator.class);
  }
