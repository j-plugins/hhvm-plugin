...
public class HackConstDeclaratorImpl extends ASTWrapperPsiElement implements HackConstDeclarator {

  public HackConstDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitConstDeclarator(this);
  }
