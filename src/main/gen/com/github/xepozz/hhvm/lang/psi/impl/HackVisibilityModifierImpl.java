...
public class HackVisibilityModifierImpl extends ASTWrapperPsiElement implements HackVisibilityModifier {

  public HackVisibilityModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
