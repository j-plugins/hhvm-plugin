...
public interface HackTraitUseClause extends PsiElement {
  ...
  @NotNull
  List<HackTraitAliasClause> getTraitAliasClauseList();

  @NotNull
  List<HackTraitSelectClause> getTraitSelectClauseList();
