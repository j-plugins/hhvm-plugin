...
public class HackUsingStatementImpl extends HackStatementImpl implements HackUsingStatement {

  public HackUsingStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public HackExpressionStatement getExpressionStatement() {
    return findChildByClass(HackExpressionStatement.class);
  }
