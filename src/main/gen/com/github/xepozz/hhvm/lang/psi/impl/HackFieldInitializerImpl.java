...
public class HackFieldInitializerImpl extends ASTWrapperPsiElement implements HackFieldInitializer {

  public HackFieldInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
