...
public class HackInoutModifierImpl extends ASTWrapperPsiElement implements HackInoutModifier {

  public HackInoutModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitInoutModifier(this);
  }
