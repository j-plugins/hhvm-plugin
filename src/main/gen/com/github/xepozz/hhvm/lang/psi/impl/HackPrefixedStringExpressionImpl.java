...
public class HackPrefixedStringExpressionImpl extends HackExpressionImpl implements HackPrefixedStringExpression {

  public HackPrefixedStringExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitPrefixedStringExpression(this);
  }
