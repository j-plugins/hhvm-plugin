...
public class HackElementInitializerImpl extends ASTWrapperPsiElement implements HackElementInitializer {

  public HackElementInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitElementInitializer(this);
  }
