...
public class HackXhpCloseImpl extends ASTWrapperPsiElement implements HackXhpClose {

  public HackXhpCloseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitXhpClose(this);
  }
