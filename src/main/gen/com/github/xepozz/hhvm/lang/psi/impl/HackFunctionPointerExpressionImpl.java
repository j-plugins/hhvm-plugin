...
public class HackFunctionPointerExpressionImpl extends HackExpressionImpl implements HackFunctionPointerExpression {

  public HackFunctionPointerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitFunctionPointerExpression(this);
  }
  ...
  public HackTypeArguments getTypeArguments() {
    return findNotNullChildByClass(HackTypeArguments.class);
  }
