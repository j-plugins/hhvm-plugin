...
public class HackFinalModifierImpl extends ASTWrapperPsiElement implements HackFinalModifier {

  public HackFinalModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HackVisitor visitor) {
    visitor.visitFinalModifier(this);
  }
